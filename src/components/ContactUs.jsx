...
const ContactUs = () => {
  document.title = "VegaMovies | Contact Us";
  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="w-full flex items-center md:px-[5%] px-2 py-3 justify-between mb-10">
        ...
        <h1 className=" text-2xl font-semibold text-zinc-400 w-full ">
          <i
            onClick={() => navigate(-1)}
      ...
      <div className="w-full max-w-4xl mx-auto px-5">
        ...
        <div className="mb-12">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed mb-6">
            Welcome to VegaMovies - your ultimate destination for movies and TV shows database. 
          ...
          <div className="space-y-8">
            ...
            <div className="bg-zinc-900 p-6 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="text-zinc-300 font-medium mb-1">Is VegaMovies free to use?</h4>
                  <p className="text-zinc-400 text-sm">
                    Yes! VegaMovies is completely free to use for all movie and TV show enthusiasts.
                  </p>
                </div>
              </div>
            </div>
